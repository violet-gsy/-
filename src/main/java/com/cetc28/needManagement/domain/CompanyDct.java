...
public class CompanyDct implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getCompanyCode() == null ? other.getCompanyCode() == null : this.getCompanyCode().equals(other.getCompanyCode()))
            ...
            && (this.getCompanyClass() == null ? other.getCompanyClass() == null : this.getCompanyClass().equals(other.getCompanyClass()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getCompanyClass() == null) ? 0 : getCompanyClass().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", companyClass=").append(companyClass);
